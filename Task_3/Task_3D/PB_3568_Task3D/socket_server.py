...
#Team ID:			3568
# Author List:		 Kashmira Sukhtankar ,Yash Waghmare, Ishita Yadav,
# Filename:			socket_server.py
# Functions:		def setup_server, def setup_connection,def receive_message_via_socket,def send_message_via_socket
# 					
